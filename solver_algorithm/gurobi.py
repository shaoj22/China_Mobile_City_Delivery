...
Description:
-----------
gurobi for the MVVRPTW problem.
-----------
Author: 626
...
class GurobiSolver1():
    def __init__(self, graph, max_car, TimeLimit=300):
        self.name = "Gurobi"
        self.graph = graph
    ...
    def run(self):
        self.vehicleNum = self.max_car # set max vehicle number
...
if __name__ == "__main__":
    ...
    solver = GurobiSolver1(graph, max_car=5, TimeLimit=1600)
    solver.run()
    solver.show_results()
    solver.show_routes()
