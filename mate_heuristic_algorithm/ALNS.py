...
Description:
-----------
ALNS mate-heuristic algorithm for the MVVRPTW problem.
-----------
Author: 626
...
from mate_heuristic_algorithm.VNS import VNS
...
if __name__ == "__main__":
    input_path = "D:\\Desktop\\python_code\\China_Mobile_City_Delivery\\inputs\\myInstance10"
    ...
    output_result(graph, routes, "test")
